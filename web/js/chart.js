...
class ServeurTCP {
  ...
  try {
    ...
    //créer une flux d'entrée attachée à la socket
    BufferdReader entreeDepuisClient = new BufferdReader (new InputStreamReader(SocketConnexion.getInputStream()));
